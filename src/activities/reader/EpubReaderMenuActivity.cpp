...
const bool hasFootnotes, const bool hasBookmarks, const BookStatus currentStatus)
...
GUI.drawList(
      ...
      [this](int index) {
        ...
        } else if (value == MenuAction::CYCLE_STATUS) {
          // Render current book status value on the right edge of the content area.
